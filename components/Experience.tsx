    ...
    <div className="py-20 w-full">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-70">
          <div className="relative p-6 w-[80vw] md:w-[50vw] h-[60vh] rounded-lg backdrop-blur-2xl bg-black-100 border-2 border-[#6e6e6e]">
            <button
              onClick={closeModal}
              className="absolute top-3 right-3 text-black text-lg font-bold"
            >
              <i className="ri-close-circle-fill text-4xl text-[#d9d9d9]"></i>
            </button>
            <div className="flex flex-col items-start mt-8 justify-start relative w-full h-full gap-4">
              <div className="img relative w-full h-[90%] rounded-lg">
                <Image
